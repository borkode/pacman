...
pathe=easystar.findPath(posx, posy, tox, toy, function(path) {if (path != null) {console.log(path);var x=0;var pathc = [path[1].x,path[1].y];}else{pathc= [posx,posy];};return pathc;});
	easystar.calculate();
	console.log(pathe)
